...
from apis.data_api import *
from apis.weather_api import *
from apis.motion_api import *
from apis.fitness_api import *
...
if __name__ == "__main__":
    ...
    # Setup APIs
    openai_api = OpenAIGPTAPI(credentials_manager.get_credential("OPENAI_API_KEY"))
    weather_api = WeatherAPI(credentials_manager.get_credential("OPENWEATHER_API_KEY"))
    fitness_api = FitnessAPI(credentials_manager.get_credential("NOCODE_API_LINK"))
    motion_api = MotionAPI(credentials_manager.get_credential("MOTION_API_KEY"))
    combined_api = CombinedDataAPI(weather_api, fitness_api, motion_api)
    # Gather personal data
    data = combined_api.get_combined_data(CONFIG["LATITUDE"], CONFIG["LONGITUDE"], CONFIG["WEATHER_TIMEZONE"])
    # Construct template
